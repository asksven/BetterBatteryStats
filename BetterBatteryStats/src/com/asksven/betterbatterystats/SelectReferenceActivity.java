...
public class SelectReferenceActivity extends SherlockFragmentActivity
{
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// affordance.
		final LayoutInflater inflater = (LayoutInflater) getSherlock().getActionBar().getThemedContext().getSystemService(
