...
//
//import com.androidplot.demos.PointLabelFormatter;
...
//			mySimpleXYPlot.addSeries(mySeries, new LineAndPointFormatter(Color.rgb(0, 200, 0), Color.rgb(200, 0, 0), Color.argb(100, 0, 0, 100), new PointLabelFormatter(Color.WHITE)));
//	 
//			//Enact all changes
