...
public class PermissionsFragment extends SherlockListFragment
{
	...
	public static PermissionsFragment newInstance(Bundle args)
	{
	...
	private class LoadStatData extends AsyncTask<Context, Integer, PermissionsAdapter>
	{
		...
		protected PermissionsAdapter doInBackground(Context... params)
		{
			...
			try
			{
				m_listViewAdapter = new PermissionsAdapter(getActivity(), StatsProvider.getInstance(getActivity())
						.getRequestedPermissionListForPackage(getActivity(), m_packageName), m_permDictionary);
