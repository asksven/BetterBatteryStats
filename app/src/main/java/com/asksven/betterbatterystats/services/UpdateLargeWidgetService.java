 ...
 *
 */
public class UpdateLargeWidgetService extends JobIntentService
{
	private static final String TAG = "UpdateLWidgetService";
	/** must be unique for each widget */
	private static final int PI_CODE = 4;
	...
	{
		enqueueWork(context, UpdateLargeWidgetService.class, JOB_ID, work);
	}
