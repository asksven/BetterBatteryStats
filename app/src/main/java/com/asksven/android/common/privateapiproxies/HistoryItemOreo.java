 ...
 * @author sven
 */
public class HistoryItemOreo extends HistoryItem implements Serializable, Parcelable
{
    ...
    public HistoryItemOreo(Long time, Byte cmd, Byte batteryLevel, Byte batteryStatusValue,
